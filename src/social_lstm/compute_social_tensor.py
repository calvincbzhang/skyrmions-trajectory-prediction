...
def compute_social_tensor(positions, hidden_states, cell_side: float,
    ...
    :param positions: (n_particles, 2).
        The particle positions.
    :param hidden_states: (n_particles, n_states).
    ...
    :return: (n_particles, n_grid_cells * n_grid_cells * n_states)
        social tensors.
    """
    n_particles = tf.shape(positions).numpy()[0]
    ...
    for i in range(n_particles):
        ...
        # First remain only neighbor particles.
